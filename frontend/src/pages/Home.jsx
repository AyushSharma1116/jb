...
const Home = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-100 text-black overflow-x-hidden w-[98vw]">
      <Navbar />
      ...
      <main className="flex flex-col items-center justify-center flex-grow px-4 mt-20 w-full">
        <div className="text-center animate-fade-in-up space-y-10 w-full max-w-5xl">
          <h1 className="text-4xl md:text-6xl font-extrabold drop-shadow-lg leading-tight">
            Welcome to <span className="text-blue-500">Job Buddy</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/industry-role"
              className="bg-white text-blue-900 font-semibold px-8 py-3 rounded-lg shadow-lg hover:bg-blue-300 hover:scale-105 transition-all duration-300"
            >
              Get Started
            </Link>
            <Link
          ...
          <section className="mt-20 text-gray-800 py-12 px-6 rounded-3xl shadow-inner">
            <div className="max-w-6xl mx-auto grid gap-10 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center">
              {/* Benefit 1 */}
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md hover:bg-blue-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                <div className="flex justify-center mb-4">
                  <div className="bg-blue-300 rounded-full p-3">
                    <svg className="h-6 w-6 text-black-500" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Benefit 2 */}
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md hover:shadow-xl hover:bg-blue-100 hover:-translate-y-2 transition-all duration-300">
                <div className="flex justify-center mb-4">
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md hover:bg-blue-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                <div className="flex justify-center mb-4">
                  <div className="bg-blue-300 rounded-full p-3">
                    <svg className="h-6 w-6 text-black-700" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-10 text-center">
            <div>
              <h3 className="text-4xl font-bold text-blue-500">2,500+</h3>
              <p className="text-sm text-gray-700">Skills Assessed</p>
            </div>
            <div>
              <h3 className="text-4xl font-bold text-blue-500">800+</h3>
              <p className="text-sm text-gray-700">Learning Paths Generated</p>
            </div>
            <div>
              <h3 className="text-4xl font-bold text-blue-500">95%</h3>
              <p className="text-sm text-gray-700">Job Role Match Accuracy</p>
            </div>
          </div>
          <hr/>
          <footer className="mt-10 mb-5 text-center text-gray-700">
